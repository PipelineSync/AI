...
async function pushLead({ email, name, fields, blueprint, voiceCall, contactId, env, fetchImpl }) {
  const cfg = hubspotConfig(env);
  ...
  try {
    await createNoteForContact(id, dealId, fields, blueprint, voiceCall, cfg, fetchImpl);
  } catch (e) {
